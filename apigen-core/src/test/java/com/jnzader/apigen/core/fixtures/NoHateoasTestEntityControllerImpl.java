...
public class NoHateoasTestEntityControllerImpl
        extends BaseControllerImpl<TestEntity, TestEntityDTO, Long>
        implements TestEntityController {

    public NoHateoasTestEntityControllerImpl(
            TestEntityService service, TestEntityMapperAdapter mapper) {
