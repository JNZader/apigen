...
/**
 * Integration tests for BaseResourceAssembler. Tests HATEOAS link generation through the controller
 * endpoints.
 */
@SpringBootTest
...
class BaseResourceAssemblerIntegrationTest {
    ...
    class CollectionResourceTests {
        ...
        void shouldIncludeItemsWithHateoasLinksInCollection() throws Exception {
            ...
            assertThat(responseBody).contains("_embedded").contains("_links");
        }
    ...
    class CreatedResourceTests {
        ...
        void shouldReturnHateoasLinksOnCreate() throws Exception {
            ...
            String responseBody = result.getResponse().getContentAsString();
            assertThat(responseBody).contains("_links").contains("\"self\"");
        }
    }
