 ...
 * <p>
 * Habilita @Async para event handlers y otras tareas asíncronas.
 * Usa Virtual Threads cuando están habilitados (Java 21+).
 */
@Configuration
@EnableAsync
public class AsyncConfig {
    ...
    /**
     * Executor para tareas de eventos de dominio usando Virtual Threads.
    ...
    public Executor virtualThreadDomainEventExecutor() {
        ...
        executor.setTaskDecorator(task -> () -> {
            ...
            try {
                ...
                log.debug("Domain event task completed in {}ms", System.currentTimeMillis() - start);
            }
        });
