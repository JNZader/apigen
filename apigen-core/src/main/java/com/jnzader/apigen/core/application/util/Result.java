...
/**
 * Una interfaz sellada que representa el resultado de una operación, que puede ser exitosa o fallida.
 * Este patrón permite un manejo de errores explícito y funcional, similar a Either en lenguajes funcionales.
 *
...
public sealed interface Result<T, E> {
    ...
    /**
     * Implementación de {@link Result} que representa un éxito.
     * Contiene el valor de la operación.
     */
    record Success<T, E>(T value) implements Result<T, E> {}

    /**
     * Implementación de {@link Result} que representa un fallo.
     * Contiene el error de la operación.
     */
    ...
    /**
     * Permite transformar el resultado aplicando una función dependiendo de si es
     * un éxito o un fallo.
     *
    ...
    /**
     * Retorna el valor si es éxito, o lanza la excepción si es fallo.
     * Si el error no es un Throwable, lanza OperationFailedException con el mensaje del error.
     *
     * @return El valor contenido si es éxito.
     * @throws OperationFailedException si es fallo y el error no es Throwable o es checked exception.
     ...
     */
    default Result<T, E> filter(java.util.function.Predicate<? super T> predicate, Supplier<E> errorSupplier) {
        return switch (this) {
            case Success<T, E>(T value) -> predicate.test(value) ? new Success<>(value) : new Failure<>(errorSupplier.get());
