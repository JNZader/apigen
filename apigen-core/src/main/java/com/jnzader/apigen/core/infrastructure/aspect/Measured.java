 ...
 *
 * <p>Solo los métodos anotados con @Measured serán instrumentados por MetricsAspect. Esto reduce el
 * overhead de instrumentación automática en toda la aplicación.
 *
 * <p>Uso:
 *
 * <pre>{@code
...
public @interface Measured {
    ...
    /** Nombre de la métrica (opcional). Si no se especifica, se usa el nombre del método. */
    String name() default "";
    ...
    /**
     * Umbral en milisegundos para logging de métodos lentos. -1 significa usar el valor por defecto
     * del aspecto.
     */
