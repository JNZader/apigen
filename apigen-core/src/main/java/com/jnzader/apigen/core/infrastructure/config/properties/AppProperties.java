 ...
 *
 * <p>Mapea todas las propiedades bajo el prefijo 'app' a clases Java con validación y type-safety.
 */
@ConfigurationProperties(prefix = "app")
@Validated
public record AppProperties(
        @NestedConfigurationProperty ApiProperties api,
    ...
    public record MetricsProperties(boolean enabled, @Positive long slowThresholdMs) {
    ...
    public record SecurityProperties(List<String> publicEndpoints) {
    ...
    public record CacheProperties(CacheConfig entities, CacheConfig lists, CacheConfig counts) {
        ...
        public record CacheConfig(@Positive long maxSize, Duration expireAfterWrite) {}
    }
