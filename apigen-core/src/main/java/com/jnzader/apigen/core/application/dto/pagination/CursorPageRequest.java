 ...
 * <p>
 * El cursor es una representación codificada en Base64 del último ID visto,
 * lo que permite una paginación eficiente sin los problemas de offset:
 * - Performance constante independiente de la página
 * - Sin duplicados/omisiones al insertar/eliminar datos
 * <p>
 * Formato del cursor: Base64(id:sortField:sortValue:direction)
 *
...
public record CursorPageRequest(
     ...
     */
    public static String encodeCursor(Long id, String sortField, String sortValue, SortDirection direction) {
        String raw = String.format("%d:%s:%s:%s", id, sortField, sortValue != null ? sortValue : "", direction.name());
