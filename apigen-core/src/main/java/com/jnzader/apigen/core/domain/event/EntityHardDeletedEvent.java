 ...
 *
 * <p>A diferencia de {@link EntityDeletedEvent}, este evento no contiene la entidad ya que fue
 * eliminada permanentemente de la base de datos. En su lugar, almacena la información necesaria
 * para identificar qué entidad fue eliminada.
 *
 * @param <I> El tipo del identificador de la entidad.
 */
public record EntityHardDeletedEvent<I extends Serializable>(
        I entityId, String entityType, String deletedBy, LocalDateTime occurredOn)
