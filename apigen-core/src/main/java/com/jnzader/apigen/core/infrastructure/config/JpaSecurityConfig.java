 ...
 * <p>
 * Esta configuración solo se activa cuando Spring Security está disponible
 * en el classpath. Provee un AuditorAware que obtiene el usuario actual
 * del SecurityContext.
 */
@Configuration
...
public class JpaSecurityConfig {
    ...
    /**
     * Provee el usuario actual para auditoría basado en Spring Security.
