 ...
 * <p>
 * Utilizada en operaciones PUT donde se requiere consistencia entre
 * el ID de la URL y el ID del recurso en el cuerpo de la solicitud.
 */
public class IdMismatchException extends RuntimeException {
    ...
    public IdMismatchException(Object pathId, Object bodyId) {
        super(String.format("El ID del path (%s) no coincide con el ID del body (%s)", pathId, bodyId));
        this.pathId = pathId;
        this.bodyId = bodyId;
    }
