 ...
 * <p>
 * Centraliza la gestión de errores para proporcionar respuestas consistentes
 * conforme al estándar RFC 7807 (Problem Details for HTTP APIs).
 * <p>
...
public class GlobalExceptionHandler {
    ...
    /**
     * Maneja las excepciones de tipo {@link DuplicateResourceException}.
    ...
    /**
     * Maneja las excepciones de tipo {@link ValidationException}.
    ...
    /**
     * Maneja las excepciones de tipo {@link IdMismatchException}.
     * Retorna un estado HTTP 400 Bad Request.
     */
    ...
    /**
     * Maneja las excepciones de tipo {@link PreconditionFailedException}.
     * Retorna un estado HTTP 412 Precondition Failed (para ETag mismatch).
     */
    ...
    /**
     * Maneja las excepciones de tipo {@link OperationFailedException}.
    ...
    /**
     * Maneja las excepciones de tipo {@link UnauthorizedActionException}.
     * Retorna un estado HTTP 403 Forbidden.
     */
    ...
    /**
     * Maneja las excepciones de validación de argumentos de método (@Valid en DTOs).
     * Retorna un estado HTTP 400 Bad Request con lista de errores de validación.
     */
    ...
    /**
     * Maneja las excepciones de tipo {@link HttpMessageNotReadableException}.
     * Se lanza cuando el JSON del body no puede ser parseado (malformado).
     * Retorna un estado HTTP 400 Bad Request.
     */
    ...
    /**
     * Maneja las excepciones de tipo {@link ConstraintViolationException}.
     * Se lanza cuando los parámetros de query o path violan restricciones de validación.
     * Retorna un estado HTTP 400 Bad Request.
     */
    ...
    public ResponseEntity<ProblemDetail> handleConstraintViolationException(
        ...
        ProblemDetail problem = ProblemDetail.builder()
                ...
                .status(HttpStatus.BAD_REQUEST.value())
                .detail("Los parámetros de la solicitud no cumplen con las restricciones de validación")
                .instance(request.getRequestURI())
                .extensions(extensions)
                .build();
    ...
    /**
     * Maneja las excepciones de tipo {@link MethodArgumentTypeMismatchException}.
     * Se lanza cuando un parámetro no puede ser convertido al tipo esperado.
     * Retorna un estado HTTP 400 Bad Request.
     */
    ...
    public ResponseEntity<ProblemDetail> handleMethodArgumentTypeMismatchException(
        ...
        ProblemDetail problem = ProblemDetail.builder()
                ...
                .status(HttpStatus.BAD_REQUEST.value())
                .detail(String.format("El parámetro '%s' tiene un valor inválido: '%s'",
