...
/**
 * Interfaz de mapeo genérica para la conversión entre una entidad y su DTO correspondiente.
 * Utiliza MapStruct para generar la implementación en tiempo de compilación.
 * <p>
 * Proporciona métodos para:
 * - Conversión entity -> DTO
 * - Conversión DTO -> entity
 * - Actualización parcial de entidades (para PATCH)
...
public interface BaseMapper<E extends Base, D extends BaseDTO> {
     ...
     * Mapea el campo 'estado' de la entidad al campo 'activo' del DTO.
     *
     ...
     * Realiza el mapeo inverso de 'activo' a 'estado'.
     *
     ...
     * Útil para operaciones PATCH donde solo se envían los campos a modificar.
