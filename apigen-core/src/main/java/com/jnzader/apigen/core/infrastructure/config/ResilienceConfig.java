 ...
 * - Rate Limiter: limita la tasa de solicitudes
...
public class ResilienceConfig {
     ...
     * <p>
     * Parámetros:
     * - failureRateThreshold: 50% de fallos abre el circuito
     ...
     * - permittedNumberOfCallsInHalfOpenState: 3 llamadas de prueba
     * - minimumNumberOfCalls: 10 llamadas mínimas para calcular métricas
     ...
     * <p>
     * Parámetros:
     * - limitForPeriod: 100 llamadas por período
     ...
     * - waitDuration: 500ms entre intentos
