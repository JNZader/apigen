 ...
 * <p>
 * Maneja login, registro y refresh de tokens.
 */
@Service
...
public class AuthService {
     ...
     * <p>
     * Implementa rotación de refresh tokens: el token usado se invalida
     * y se emite uno nuevo junto con el access token.
     */
    @Transactional
