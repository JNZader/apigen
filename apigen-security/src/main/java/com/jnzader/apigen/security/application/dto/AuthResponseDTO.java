...
public record AuthResponseDTO(
        @Schema(
                ...
                example = "eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCIsImtpZCI6ImtleS0xIn0.eyJzdWIiOiJhZG1pbiIsImlhdCI6MTcwNjAwMDAwMCwiZXhwIjoxNzA2MDAzNjAwfQ.signature")
        String accessToken,
        ...
        @Schema(description = "Fecha y hora de expiración del access token", example = "2024-01-23T12:00:00Z")
        Instant expiresAt,
    ...
    public record UserInfoDTO(
            ...
            @Schema(description = "Nombre completo", example = "Admin User")
            String fullName,

            @Schema(description = "Rol principal del usuario", example = "ROLE_ADMIN")
            String role,

            @Schema(description = "Permisos del usuario", example = "[\"READ\", \"WRITE\", \"DELETE\"]")
