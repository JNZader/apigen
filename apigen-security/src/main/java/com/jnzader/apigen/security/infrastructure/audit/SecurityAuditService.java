 ...
 * <p>
 * Proporciona métodos para registrar eventos de seguridad
 * como autenticación, autorización, acceso denegado, etc.
 */
@Service
public class SecurityAuditService {
    ...
    private void logEvent(SecurityAuditEvent event) {
        ...
        auditLog.info("SECURITY_EVENT type={} user={} ip={} resource={} action={} outcome={} details={}",
                event.eventType(),
