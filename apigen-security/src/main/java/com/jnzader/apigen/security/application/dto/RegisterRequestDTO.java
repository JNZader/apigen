                ...
                @Pattern(
                        ...
                        message =
                                "El nombre de usuario solo puede contener letras, números y guiones"
                                        + " bajos")
                String username,
        @NotBlank(message = "La contraseña es requerida") @StrongPassword String password,
        @NotBlank(message = "El email es requerido")
                @Email(message = "El email debe ser válido")
                @Size(max = 100, message = "El email no puede exceder 100 caracteres")
                String email,
        @Size(max = 100, message = "El nombre no puede exceder 100 caracteres") String firstName,
