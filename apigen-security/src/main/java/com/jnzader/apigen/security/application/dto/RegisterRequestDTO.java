...
public record RegisterRequestDTO(
        @Schema(
                description = "Nombre de usuario único (3-50 caracteres, solo alfanuméricos y guión bajo)",
                example = "john_doe",
                minLength = 3,
                maxLength = 50,
        ...
        @Schema(
                description = "Contraseña segura (mínimo 8 caracteres, mayúscula, minúscula, número y especial)",
