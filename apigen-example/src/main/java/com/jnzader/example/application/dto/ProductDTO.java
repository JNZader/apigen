 ...
 * <p>
 * Implements {@link BaseDTO} which requires id() and activo() methods.
 * Using Java records for immutability and automatic equals/hashCode/toString.
 */
public record ProductDTO(
     ...
     */
    public static ProductDTO of(Long id, Boolean activo, String name, String description,
                                BigDecimal price, Integer stock, String category, String sku) {
