...
public record ProblemDetail(
    ...
    /** Creates a ProblemDetail for external service failure. */
    public static ProblemDetail externalServiceError(String detail, String serviceName) {
        return builder()
                .type(URI.create(BASE_TYPE_URI + "external-service-error"))
                .status(502)
                .title("External service error")
                .detail(detail)
                .extension("service", serviceName)
                .build();
    }
