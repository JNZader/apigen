...
class CategoryDTOTest {
    ...
    class BaseDTOMethods {
        ...
        void activoShouldReturnDefaultTrue() {
            CategoryDTO builtDto = CategoryDTO.builder().build();
    ...
    class BuilderTests {
        ...
        void shouldBuildDtoWithAllFields() {
            CategoryDTO builtDto = CategoryDTO.builder()
                    .id(1L)
                    .activo(true)
                    .build();
    ...
    class EqualsHashCodeTests {
        ...
        void dtosWithDifferentValuesShouldNotBeEqual() {
            CategoryDTO dto1 = CategoryDTO.builder().id(1L).build();
            CategoryDTO dto2 = CategoryDTO.builder().id(2L).build();
