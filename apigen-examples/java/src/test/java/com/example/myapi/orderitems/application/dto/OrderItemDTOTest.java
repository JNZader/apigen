...
class OrderItemDTOTest {
    ...
    class BaseDTOMethods {
        ...
        void activoShouldReturnDefaultTrue() {
            OrderItemDTO builtDto = OrderItemDTO.builder().build();
    ...
    class BuilderTests {
        ...
        void shouldBuildDtoWithAllFields() {
            OrderItemDTO builtDto = OrderItemDTO.builder()
                    .id(1L)
                    .activo(true)
                    .build();
    ...
    class EqualsHashCodeTests {
        ...
        void dtosWithSameValuesShouldBeEqual() {
            OrderItemDTO dto1 = OrderItemDTO.builder().id(1L).activo(true).build();
            OrderItemDTO dto2 = OrderItemDTO.builder().id(1L).activo(true).build();
        ...
        void dtosWithDifferentValuesShouldNotBeEqual() {
            OrderItemDTO dto1 = OrderItemDTO.builder().id(1L).build();
            OrderItemDTO dto2 = OrderItemDTO.builder().id(2L).build();
