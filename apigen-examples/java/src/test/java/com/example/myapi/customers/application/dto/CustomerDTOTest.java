...
class CustomerDTOTest {
    ...
    class BaseDTOMethods {
        ...
        void activoShouldReturnDefaultTrue() {
            CustomerDTO builtDto = CustomerDTO.builder().build();
    ...
    class BuilderTests {
        ...
        void shouldBuildDtoWithAllFields() {
            CustomerDTO builtDto = CustomerDTO.builder()
                    .id(1L)
                    .activo(true)
                    .build();
    ...
    class EqualsHashCodeTests {
        ...
        void dtosWithSameValuesShouldBeEqual() {
            CustomerDTO dto1 = CustomerDTO.builder().id(1L).activo(true).build();
            CustomerDTO dto2 = CustomerDTO.builder().id(1L).activo(true).build();
        ...
        void dtosWithDifferentValuesShouldNotBeEqual() {
            CustomerDTO dto1 = CustomerDTO.builder().id(1L).build();
            CustomerDTO dto2 = CustomerDTO.builder().id(2L).build();
