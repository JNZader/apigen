package com.example.myapi.categories;
...
class CategoryIntegrationTest {
    ...
    @DisplayName("1. POST - Should create new Category")
    void shouldCreateNewCategory() throws Exception {
        ...
        CategoryDTO created = jsonMapper.readValue(response, CategoryDTO.class);
    ...
    @DisplayName("2. GET /{id} - Should find Category by ID")
    ...
    @DisplayName("3. GET - Should list all Category with pagination")
    ...
    @DisplayName("4. HEAD /{id} - Should check Category exists")
    ...
    @DisplayName("6. PUT /{id} - Should update Category")
    void shouldUpdateCategory() throws Exception {
        ...
        CategoryDTO dto = jsonMapper.readValue(
                getResult.getResponse().getContentAsString(), CategoryDTO.class);

        dto.setName("Updated name");
        dto.setDescription("Updated description");
        dto.setSlug("Updated slug");
    ...
    @DisplayName("7. PATCH /{id} - Should partial update Category")
    void shouldPartialUpdateCategory() throws Exception {
        assertThat(createdId).isNotNull();
    ...
    @DisplayName("8. DELETE /{id} - Should soft delete Category")
    ...
    @DisplayName("9. POST /{id}/restore - Should restore soft-deleted Category")
    void shouldRestoreCategory() throws Exception {
        assertThat(createdId).isNotNull();
    ...
    @DisplayName("10. DELETE /{id}?permanent=true - Should permanently delete Category")
    void shouldPermanentlyDeleteCategory() throws Exception {
        assertThat(createdId).isNotNull();
    ...
    @DisplayName("11. GET /{id} - Should return 404 for non-existent Category")
    ...
    void shouldValidateRequiredFields() throws Exception {
        CategoryDTO invalidDto = CategoryDTO.builder().build();
    ...
    void shouldSupportCursorPagination() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            CategoryDTO uniqueDto = CategoryDTO.builder()
                        .activo(true)
                        ...
                        .slug("Test slug" + "-" + java.util.UUID.randomUUID().toString().substring(0, 8) + "-" + i)
                        .build();
            mockMvc.perform(post(BASE_URL)
                            .contentType(MediaType.APPLICATION_JSON)
