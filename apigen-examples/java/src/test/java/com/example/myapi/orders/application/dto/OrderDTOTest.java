...
class OrderDTOTest {
    ...
    class BaseDTOMethods {
        ...
        void activoShouldReturnDefaultTrue() {
            OrderDTO builtDto = OrderDTO.builder().build();
    ...
    class BuilderTests {
        ...
        void shouldBuildDtoWithAllFields() {
            OrderDTO builtDto = OrderDTO.builder()
                    .id(1L)
                    .activo(true)
                    .build();
    ...
    class EqualsHashCodeTests {
        ...
        void dtosWithSameValuesShouldBeEqual() {
            OrderDTO dto1 = OrderDTO.builder().id(1L).activo(true).build();
            OrderDTO dto2 = OrderDTO.builder().id(1L).activo(true).build();
