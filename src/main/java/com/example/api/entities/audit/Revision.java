...
/**
 * La clase Revision representa una entidad que almacena información sobre las
 * revisiones de las entidades auditadas en la aplicación. Utiliza Hibernate
 * Envers para manejar la auditoría de los cambios.
 */
@Entity
