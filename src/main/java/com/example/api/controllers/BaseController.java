...
/**
 * BaseController es una interfaz que define las operaciones básicas para el
 * manejo de entidades en la aplicación.
 *
 * @param <E> el tipo de la entidad que extiende de {@link Base}
 * @param <D> el tipo del DTO (Data Transfer Object) asociado
 * @param <ID> el tipo del identificador de la entidad, que debe ser
 * serializable
 */
