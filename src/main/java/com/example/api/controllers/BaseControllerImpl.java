...
/**
 * BaseControllerImpl es una clase abstracta que implementa la interfaz
 * {@link BaseController} y proporciona la implementación básica de las
 * operaciones CRUD para entidades.
 *
 * @param <E> el tipo de la entidad que extiende de {@link Base}
 * @param <D> el tipo del DTO (Data Transfer Object) asociado que extiende de
 * {@link BaseDTO}
