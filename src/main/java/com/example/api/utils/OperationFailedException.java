...
/**
 * Excepción personalizada que se lanza cuando una operación no puede
 * completarse. Esta clase extiende RuntimeException, lo que significa que es
 * una excepción no comprobada (unchecked) y no requiere declaración en los
 * métodos.
 */
