...
public abstract class BaseServiceImpl<E extends Base, D, ID extends Serializable> implements BaseService<E, D, ID> {
    ...
    /**
     * El objeto logger utilizado para registrar mensajes y eventos en la
     * aplicación.
     */
    ...
    /**
     * Constructor que inicializa el repositorio base, el mapeador y el
     * EntityManager.
     *
     * @param repositories la lista de repositorios utilizados para realizar
     * operaciones CRUD
     * @param mapperGen la lista de mappers utilizados para convertir entre
     * entidades y DTOs
     * @param baseRepository el repositorio base utilizado para realizar
     * operaciones CRUD
     * @param mapper el mapeador que convierte entre entidades y DTOs
     * @param entityManager el EntityManager para realizar operaciones de
     * persistencia
     */
    @Autowired
    ...
    /**
     * Recupera todas las entidades de la base de datos y las convierte en una
     * lista de DTOs.
     *
     * @return una lista de objetos DTO que representan todas las entidades en
     * la base de datos
     * @throws OperationFailedException si ocurre un error al obtener la lista
     * de entidades
     */
    @Override
    ...
    /**
     * Recupera una página de entidades de la base de datos y las convierte en
     * una página de DTOs.
     *
     * @param pageable la información de paginación y ordenamiento
     * @return una página de objetos DTO que representan las entidades en la
     * base de datos
     * @throws OperationFailedException si ocurre un error al obtener la lista
     * de entidades
     */
    ...
    /**
     * Recupera una entidad de la base de datos por su identificador y la
     * convierte en un DTO.
     *
     * @param id el identificador de la entidad a recuperar
     * @return el objeto DTO que representa la entidad, o lanza una excepción si
     * no se encuentra
     * @throws ResourceNotFoundException si la entidad no se encuentra en la
     * base de datos
    ...
    /**
     * Guarda una nueva entidad en la base de datos a partir del DTO
     * proporcionado.
     *
    ...
    public D save(D dto) {
        try {
            ...
            // Establece el estado de la entidad si es null
    ...
    /**
     * Actualiza una entidad existente en la base de datos con los datos del DTO
     * proporcionado.
     *
     ...
     * @throws ResourceNotFoundException si la entidad con el ID proporcionado
     * no existe
     * @throws OperationFailedException si ocurre un error al actualizar la
     * entidad
     */
    @Override
    @Transactional
    public D update(ID id, D dto) {
        try {
            ...
            // Establece el estado de la entidad si es null
            if (updatedEntity.getEstado() == null) {
                updatedEntity.setEstado(true);
            }
    ...
    /**
     * Elimina una entidad de la base de datos identificada por el ID
     * proporcionado.
     *
     ...
     * @throws ResourceNotFoundException si la entidad con el ID proporcionado
     * no existe
     * @throws OperationFailedException si ocurre un error al eliminar la
     * entidad
     */
    @Override
    @Transactional
    ...
    private <T extends BaseRepository<?, Long>> T getRepositoryImpl(Class<T> clazz) {
        // Utiliza el méto do `stream` para obtener un flujo de repositorios
    ...
    /**
     * Obtiene el mapper específico para convertir entre una entidad y su
     * correspondiente DTO
     */
    @SuppressWarnings("unchecked")
