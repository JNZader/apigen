...
@SuppressWarnings("java:S5976") // Tests validate different specific repository features, not the same feature with different inputs
class RepositoryGeneratorTest {
    ...
    class GenerateTests {
        ...
        void shouldExtendBaseRepositoryWithCorrectTypes() {
            ...
            assertThat(result).contains("public interface ProductRepository extends BaseRepository<Product, Long>");
        }
        ...
        void shouldGenerateFindByMethodForUniqueColumn() {
            SqlColumn uniqueColumn = SqlColumn.builder()
                    .name("email")
                    .javaType("String")
                    .nullable(false)
                    .unique(true)
        ...
        void shouldNotGenerateFindByMethodForPrimaryKeyColumn() {
            SqlColumn pkColumn = SqlColumn.builder()
                    .name("id")
                    .javaType("Long")
                    .nullable(false)
                    .unique(true)
        ...
        void shouldGenerateMultipleFindByMethodsForMultipleUniqueColumns() {
            List<SqlColumn> columns = List.of(
                    ...
                    SqlColumn.builder().name("email").javaType("String").unique(true).primaryKey(false).build(),
                    SqlColumn.builder().name("username").javaType("String").unique(true).primaryKey(false).build()
            );
        ...
        void shouldGenerateMethodForSqlFunction() {
            ...
            SqlFunction function = SqlFunction.builder()
            ...
            assertThat(result)
                    ...
                    .contains("@Query(value = \"SELECT * FROM get_product_stats(:product_id)\", nativeQuery = true)");
        }
        ...
        void shouldHandleTableWithDifferentModuleName(String tableName, String moduleName, String entityName) {
            ...
            assertThat(result)
                    ...
                    .contains("public interface " + entityName + "Repository extends BaseRepository<" + entityName + ", Long>");
        }
    }
