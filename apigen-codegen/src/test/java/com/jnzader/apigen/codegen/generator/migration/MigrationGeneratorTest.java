...
@SuppressWarnings("java:S5976") // Tests validate different specific migration features, not the same feature with different inputs
    ...
    class GenerateTests {
        ...
        void shouldGenerateStandardIndexes() {
            ...
            assertThat(result)
                    ...
                    .contains("CREATE INDEX idx_products_fecha_creacion ON products(fecha_creacion DESC);");
        }
        ...
        void shouldGenerateIndexForForeignKey() {
            ...
            assertThat(result).contains("CREATE INDEX idx_products_category ON products(category_id);");
        }
        ...
        void shouldGenerateForeignKeyConstraints() {
            ...
            assertThat(result)
                    ...
                    .contains("ALTER TABLE products ADD CONSTRAINT fk_products_category FOREIGN KEY (category_id) REFERENCES categories(id);");
        }

        @Test
        @DisplayName("Should handle multiple foreign keys")
        void shouldHandleMultipleForeignKeys() {
            List<SqlForeignKey> fks = List.of(
