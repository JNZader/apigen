...
/**
 * Centralized configuration for versions used in generated projects.
 * Change values here to update all generated project dependencies.
 *
 * <p>These versions are used when generating new Spring Boot projects
 * and their build.gradle files.</p>
 */
public final class GeneratedProjectVersions {
     ...
     */
    public static final String SQLSERVER_DOCKER_IMAGE = "mcr.microsoft.com/mssql/server:2022-latest";
    ...
    /**
     * Eclipse Temurin JRE base image pattern.
     * Use with String.format(TEMURIN_JRE_IMAGE_PATTERN, javaVersion)
     */
