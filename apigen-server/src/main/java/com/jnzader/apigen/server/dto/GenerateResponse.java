...
/** Response DTO for project generation. Contains information about the generation result. */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class GenerateResponse {
    ...
    public static GenerateResponse success(
            String message, List<String> files, GenerationStats stats) {
    ...
    public static GenerateResponse error(String message, List<String> errors) {
        return GenerateResponse.builder().success(false).message(message).errors(errors).build();
    }
}
