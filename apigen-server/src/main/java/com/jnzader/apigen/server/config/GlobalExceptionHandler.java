...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GenerateResponse> handleValidationErrors(MethodArgumentNotValidException ex) {
    ...
    public ResponseEntity<GenerateResponse> handleGenerationError(GeneratorController.GenerationException ex) {
