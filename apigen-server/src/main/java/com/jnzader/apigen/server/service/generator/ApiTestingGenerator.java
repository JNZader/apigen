...
public class ApiTestingGenerator {
    ...
    private static final String POSTMAN_SCHEMA_URL = "https://schema.getpostman.com/json/collection/v2.1.0/collection.json";
    ...
    public String generateHttpTestFile(SqlSchema schema) {
        ...
        sb.append("""
                ...
                @baseUrl =""").append(" ").append(DEFAULT_BASE_URL).append("""
        ...
        for (SqlTable table : schema.getEntityTables()) {
            ...
            sb.append("\n# =============================================================================\n");
            sb.append("# ").append(entityName.toUpperCase()).append(" ENDPOINTS (").append(moduleName).append(")\n");
            sb.append("# =============================================================================\n\n");
            ...
            sb.append("### 11. Restore soft-deleted ").append(entityName.toLowerCase()).append("\n");
     ...
     */
    public String generatePostmanCollection(SqlSchema schema, GenerateRequest.ProjectConfig config) {
        ...
        sb.append("    \"description\": \"API Collection generated by APiGen Studio. Import this file into Postman to test all endpoints.\",\n");
        ...
        for (int t = 0; t < tables.size(); t++) {
            ...
            // 1. GET / - List all
            requests.add(generatePostmanRequest(
                    "List all " + moduleName,
                    "GET",
     ...
     */
    private String generatePostmanRequest(String name, String method, String url, String body, String description) {
        StringBuilder sb = new StringBuilder();
        sb.append("        {\n");
        ...
        String pathPart = urlPath.contains("?") ? urlPath.substring(0, urlPath.indexOf("?")) : urlPath;
        String queryPart = urlPath.contains("?") ? urlPath.substring(urlPath.indexOf("?") + 1) : null;

        sb.append("              \"host\": [\"{{baseUrl}}\"],\n");
        if (!pathPart.isEmpty()) {
            String[] pathSegments = pathPart.substring(1).split("/");
            sb.append("              \"path\": [");
            sb.append(Arrays.stream(pathSegments).map(s -> "\"" + s + "\"").collect(Collectors.joining(", ")));
            sb.append("]");
        } else {
            sb.append("              \"path\": []");
        }
        ...
        if (queryPart != null) {
            ...
            for (int i = 0; i < params.length; i++) {
                ...
                sb.append("                  \"value\": \"").append(kv.length > 1 ? kv[1] : "").append("\"\n");
                sb.append("                }");
    ...
    private String generatePartialUpdateJson(SqlTable table) {
        ...
        if (!cols.isEmpty()) {
            ...
            json.append("  \"").append(firstCol.getJavaFieldName()).append("\": ")
